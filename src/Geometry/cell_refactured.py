...
class Cell(ABC):
    ...
    def findScaledNormales(self, allCells=None):
        ...
        if self._msh is not None and hasattr(self._msh, "_id_to_cell"):
            cellsDict = self._msh._id_to_cell
        else:
